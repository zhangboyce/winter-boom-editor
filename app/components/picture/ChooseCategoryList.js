...
export default class extends Component {
    ...
    __typeOnClick__ = (type, callback) => {
        return e => {
            e.stopPropagation();
            this.parent.choosePagination.category(type._id);
            this.parent.choosePagination.page(1);
            this.parent.chooseUploadImage.category(type);
            this.parent.choosePagination.pagination(callback);
        };
    };
    ...
    __buildCategoryLi__ = category => {
        ...
        $li.click(this.__typeOnClick__(category, items => {
            ...
            this.parent.chooseImageList.loadImages(items);
        }));
    };
    ...
    rendered = () => {
        this.__loadTypes__(types => {
            ...
            let category = this.parent.chooseUploadImage.category();
